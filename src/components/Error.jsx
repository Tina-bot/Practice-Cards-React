...
const Error = ({ error }) => {
    ...
    return (
        <div id="alert-additional-content-2" className="p-4 mt-4 border border-red-300 rounded-lg bg-red-50 dark:bg-red-200" role="alert">
            <div className="flex items-center">
                ...
                <h3 className="text-lg font-medium text-red-900 dark:text-red-800">A little error :( </h3>
            </div>
            <div className="mt-2 text-sm text-red-900 dark:text-red-800">
                {error}
            </div>
        </div>
    )
